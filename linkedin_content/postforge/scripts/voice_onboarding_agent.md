...
## Model
Claude Opus (needed for high-quality voice synthesis in Layer 3)

## Trigger
- First-time setup: When CLAUDE.md detects voice_profile.md still says "based on brand analysis, no corpus data yet"
