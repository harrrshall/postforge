...
Layer 2: Sampled LLM Analysis — Claude Haiku on ~50 random chunks
Layer 3: Synthesis — Claude Opus distills into voice_profile.md
...
def run_pipeline(input_path: str, output_dir: str, num_samples: int = 50):
    ...
    print("=" * 60)
    print(f"\nNext steps:")
    print(f"  1. Run Layer 2 prompts through Claude Haiku (in {prompts_dir}/)")
