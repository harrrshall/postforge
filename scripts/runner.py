...
def cmd_scan():
    ...
    print("\n  Trend scanning...")
    print("  To run a full scan, invoke your AI tool with scan_agent.md instructions.")
...
def cmd_auto_research():
    ...
    print("  To run, invoke your AI tool with research_agent.md instructions.")
...
def cmd_voice_drift():
    ...
    print("  To run full drift analysis, invoke your AI tool with learn_agent.md Function C.")
